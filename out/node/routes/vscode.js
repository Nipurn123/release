...
function loadVSCode(req) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const mod = (yield eval(`import("${modPath}")`));
        const serverModule = yield mod.loadCodeWithNls();
        return serverModule.createServer(null, Object.assign(Object.assign({}, (yield (0, cli_1.toCodeArgs)(req.args))), { "accept-server-license-terms": true, 
...
const ensureVSCodeLoaded = (req, _, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        vscodeServer = yield vscodeServerPromise;
    }
    catch (error) {
