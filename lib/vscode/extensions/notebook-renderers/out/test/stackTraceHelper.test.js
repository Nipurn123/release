...
suite('StackTraceHelper', () => {
    test('Non Ipython stack trace is left alone', () => {
        ...
        assert.equal((0, stackTraceHelper_1.formatStackTrace)(stack).formattedStack, stack);
    });
    const formatSequence = /\u001b\[.+?m/g;
    function stripAsciiFormatting(text) {
    ...
    test('IPython stack line numbers are linkified', () => {
        const stack = '\u001b[1;31m---------------------------------------------------------------------------\u001b[0m\n' +
            ...
            '\u001b[1;31mException\u001b[0m\n:';
        const { formattedStack, errorLocation } = (0, stackTraceHelper_1.formatStackTrace)(stack);
    ...
    test('IPython stack line numbers are linkified for IPython 8.3', () => {
        ...
        const stack = '\u001b[1;31m---------------------------------------------------------------------------\u001b[0m\n' +
            ...
            '\n' +
            '\u001b[1;31mException\u001b[0m:\n';
        const { formattedStack } = (0, stackTraceHelper_1.formatStackTrace)(stack);
    ...
    test('IPython stack trace lines without associated location are not linkified', () => {
        const stack = '\u001b[1;31m---------------------------------------------------------------------------\u001b[0m\n' +
            ...
            '\u001b[1;32m----> 2\u001b[0m     \u001b[38;5;28;01mraise\u001b[39;00m \u001b[38;5;167;01mException\u001b[39;00m\n\n' +
            '\u001b[1;31mException\u001b[0m\n:';
        const formatted = (0, stackTraceHelper_1.formatStackTrace)(stack).formattedStack;
        assert.ok(!/<a href=.*>\d<\/a>/.test(formatted), formatted);
    });
    test('IPython stack without line numbers are not linkified', () => {
        const stack = '\u001b[1;36m  Cell \u001b[1;32mIn[6], line 1\u001b[1;36m\u001b[0m\n' +
            '\u001b[1;33m    print(\u001b[0m\n' +
            '\u001b[1;37m          ^\u001b[0m\n' +
            ...
            'a 1  print(\n' +
            '   1a  print(\n';
        const formattedLines = (0, stackTraceHelper_1.formatStackTrace)(stack).formattedStack.split('\n');
    ...
    test('background (40-49) ANSI colors are removed', () => {
        const stack = 'open\u001b[39;49m\u001b[43m(\u001b[49m\u001b[33;43m\'\u001b[39;49m\u001b[33;43minput.txt\u001b[39;49m\u001b[33;43m\'\u001b[39;49m\u001b[43m)\u001b[49m;';
        const formattedLines = (0, stackTraceHelper_1.formatStackTrace)(stack).formattedStack.split('\n');
        assert.ok(!/4\d/.test(formattedLines[0]), 'should not contain background colors ' + formattedLines[0]);
        formattedLines.slice(1).forEach(line => assert.ok(!/<a href=.*>/.test(line), 'line should not contain a link: ' + line));
    });
});
//# sourceMappingURL=stackTraceHelper.test.js.map